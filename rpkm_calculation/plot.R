...
g_all <- ggplot(data_sorted, aes(x = jittered_chr, y = rpkm, color = factor(chr_order %% 2))) +
  ...
  scale_y_log10(
    breaks = c(0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000, 100000), labels = c("0.00001", "0.0001", "0.001", "0.01", "0.1", "1", "10", "100", "1000", "10000", "100000")
  ) +
  labs(title = plot_title,
       x = "Chromosome",
       y = "RPKM") +
